...
function rCust() {
    ...
    $('cusr').oninput = debounce(() => { pState.customers.page = 1; window.doCustSearch(); }, 200);
        ...
        <div class="card">
            <h3>${L==='ar'?'رفع ملفات Excel':'Upload Excel Files'}</h3>
            <p style="margin-bottom:12px;">${L==='ar'?'ارفع ملف Excel الخاص بالمبيعات والتارجت لتحديث البيانات.':'Upload your Sales and Target Excel files to update the data.'}</p>
