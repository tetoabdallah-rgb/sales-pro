...
// We need to fix rDash in index.html
...
// Also need to patch rDorm in index.html to add Export buttons and phone extraction!
...
if (startIndexDorm !== -1 && endIndexDorm !== -1) {
    ...
    // Also patch WhatsApp injector if needed (P==='dormant')
