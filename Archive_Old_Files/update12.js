...
let uiadd_ar = '<div class="ki"><div class="lb">${L===\\'ar\\'?TUI(\\'Collections\\'):\\'Collections\\'}</div><div class="vl">${typeof aFmt !== \\'undefined\\' ? aFmt(tc) : tc}</div></div>\\n            ';
let uiadd = Buffer.from(uiadd_ar, 'utf-8').toString('utf-8');
...
for (let file of files) {
    ...
    if (content.indexOf(s4) !== -1 && content.indexOf("TUI('Collections')") === -1) {
