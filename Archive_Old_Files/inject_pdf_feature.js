...
// The script to inject at the end of the body
const pdfEnhancementScript = `
...
if (!code.includes('window.exportToPDF')) {
    code = code.replace('</body>', pdfEnhancementScript + '\n</body>');
    fs.writeFileSync(path, code);
    console.log("PDF Enhancements applied successfully!");
} else {
    console.log("PDF Enhancements already exist.");
}
