...
$settings_pattern = '(<div class="card" style="margin-bottom:20px;">\s*<h3>.*?Primary Color.*</h3>)'
$settings_new = @'
        ...
        $1
'@
$html = [System.Text.RegularExpressions.Regex]::Replace($html, $settings_pattern, $settings_new)
